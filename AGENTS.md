...
- `human-facing-prose` - load before composing a substantial captain-facing chat outcome, escalation, or decision ask, a public Relay reply or completion follow-up, `/bearings` chat-line wording, human-facing prose paragraphs in README, VISION, or operator docs, or the human-facing summary of a scout report or PR description; never for code, records, or any other precision, replay, or enforcement text.
